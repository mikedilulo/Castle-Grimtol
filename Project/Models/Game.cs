...
namespace ConsoleAdventure.Project.Models
{
  public class Game : IGame
  {
    ...
    public void Setup()
    {
      ...
      Room RoomZero = new Room("Room-Zero", "You have fallen into a pit with spikes at the bottom and have died. You have lost the game! Next time brave adventurer, you will need to make sure you follow the path and read the script");
